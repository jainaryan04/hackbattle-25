...
export default function FaqSection() {
  ...
  const faqData = [
    ...
    { question: "What is the required team size ?", answer: "Yes. Teams must have 5 members. Solo participation is not permitted, but members can come from any background or discipline.", headImageSrc: "/minecraft-head-zombie.png", characterWebM: "/Zombie.webm", characterStyle: { transform: 'translateY(155px) translateX(-50px) scale(1.2)' } },
  ];
